  ...
  const statisticData: StatisticCardProps[] = [
    {
      ...
      icon: <Files size={24} />,
      change: { percentage: "8.5%", direction: "up", description: "Up from yesterday" },
      colorScheme: "blue",
    },
    {
      label: "Done Reports",
      ...
      change: { percentage: "5.2%", direction: "up", description: "Up from last week" },
      colorScheme: "green",
    },
    {
      ...
      change: { percentage: "2.1%", direction: "down", description: "Down from yesterday" },
      colorScheme: "orange",
    },
    {
      ...
      change: { percentage: "1.3%", direction: "down", description: "Down from last month" },
      colorScheme: "red",
    },
  ];
